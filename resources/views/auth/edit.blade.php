                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="avatar" value="{{ $user->avatar }}" type="text" class="form-control @error('avatar') is-invalid @enderror" name="avatar" value="{{ old('avatar') }}" required autocomplete="avatar">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sex" value="{{ $user->sex }}" type="text" class="form-control @error('sex') is-invalid @enderror" name="sex" value="{{ old('sex') }}" required autocomplete="sex">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="show_phone" value="{{ $user->show_phone }}" type="text" class="form-control @error('show_phone') is-invalid @enderror" name="show_phone" value="{{ old('show_phone') }}" required autocomplete="show_phone">
